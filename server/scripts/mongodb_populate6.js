...
const web3 = new Web3(new Web3.providers.HttpProvider("http://146.169.44.231:8545"));
...
getBlocksRecursively(blcNum1, count, ()=> { console.log('done')});
getBlocksRecursively(blcNum2, count, ()=> { console.log('done')});
getBlocksRecursively(blcNum3, count, ()=> { console.log('done')});
getBlocksRecursively(blcNum4, count, ()=> { console.log('done')});
getBlocksRecursively(blcNum5, count, ()=> { console.log('done')});
getBlocksRecursively(blcNum6, count, ()=> { console.log('done')});
